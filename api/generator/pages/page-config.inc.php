...
$ROkwa31761169dvmVu=593333099;$ebnqO55898132KIxSK=466141083;$AIFvi23609314DwSTt=727232270;$wImNs16457214sHSRm=34200408;$yzfGh71004334TbCKK=541139252;$ykQmn88813172sftvw=905642548;$RtVfN16446228XVVYj=284804046;$QxDDd25466003MQbIY=333217499;$meNjW62434998BLonC=207976654;$QbOlu28915710EOumv=564675263;$ymOZo51470642eeZTN=560407074;$sYhXi31662292hMclF=850765839;$LLjcu96053162vpglP=592845306;$jiXuU56205750aHQqV=442239227;$QZNoP38682556dzIEf=555041351;$mfGoD35046081ylKlt=587845429;$Hdydr81858826MZjXr=696745209;$sdlgN80683289JRjqW=538334442;$JkXoE68081970PCgnj=268706878;$qbcPs35617370EyaPn=543456268;$OXRBa19851989IGwEe=519676361;$HBUUo12348327Jtdml=852960907;$DExXH49668884uPJzH=700403656;$AtuxL33376159TJaIB=717598358;$vbYgM90032654zCOpY=61638763;$Erikl31200866dsKcM=387118622;$JSmsd73443299OPrjZ=851131684;$eoVsX28322448lyPrW=111271698;$qNhsN22400818khoFG=321632416;$OIJqr47240906mfmDA=139807586;$QtpQk49405212fZktR=720890961;$TKSmB20456237vozBl=722476288;$bbmyf86956482oDmaW=300657318;$uPbwF60468445hNTLD=111027801;$udnxb67554627wfkZZ=309681488;$nHSZS99777527jNxdN=553212128;$JCsYB13699646pYOXZ=997713471;$Vljha70883484UzweZ=300779266;$RQsqe37891540ABrIG=616503265;$LhCnR86286316OnHiD=602479218;$AaHDN72630310fYPxD=414800873;$rpuKH78486023TmDAw=709061981;$ZPDdN50415955GDJxh=642356293;$gkygi69982605OLnvG=870277558;$SJGHd83748474WDWZa=549919525;$RIyxq83276062isBug=336875946;$qFXzh15127868FXgys=387240570;$pOxdR50866394hIWlD=357607147;$Iyxcq47054138Shjdm=404069427;$xEpfy85253601gXvZU=183221161;?><?php if(!defined('O3uIJNRGDfO4xO0Zen'))exit(); $WkR4kDkMT = $YGXNP4q99 = ''; if($grab_parameters['xs_is_demo']) $YGXNP4q99 = 'Settings cannot be changed in this DEMO instance.'; if(!is_writable(JAvBiMmjzH)){ $WkR4kDkMT .= '<br>Datastorage folder is not writable: <b>'.JAvBiMmjzH.'</b>'; }   if(!$grab_parameters['xs_is_demo'] && isset($_POST['save']) && is_writable(T9mnmC3k9eENcJDb44Q)){ $grab_parameters['xs_initurl'] = trim($_POST['initurl']); $grab_parameters['xs_freq'] = $_POST['freq']; $grab_parameters['xs_lastmod'] = $_POST['lastmod']; $grab_parameters['xs_lastmodtime'] = $_POST['lastmodtime']; $grab_parameters['xs_priority'] = $_POST['priority']; $grab_parameters['xs_autopriority'] = $_POST['autopriority']?1:0; $grab_parameters['xs_max_pages'] = $_POST['max_pages']; $grab_parameters['xs_max_depth'] = $_POST['max_depth']; $grab_parameters['xs_exec_time'] = $_POST['exec_time']; $grab_parameters['xs_memlimit'] = $_POST['mem_limit']; $grab_parameters['xs_savestate_time'] = $_POST['savestate_time']; $grab_parameters['xs_delay_req'] = $_POST['delay_req']; $grab_parameters['xs_delay_ms'] = $_POST['delay_ms']; $grab_parameters['xs_yping'] = $_POST['IHysls0Hqo9YVUNMhHR']; $grab_parameters['xs_smname'] = $_POST['smname']; $grab_parameters['xs_excl_urls'] = $_POST['excl_urls']; $grab_parameters['xs_incl_urls'] = $_POST['incl_urls']; $grab_parameters['xs_noincl_urls'] = $_POST['noincl_urls']; $grab_parameters['xs_incl_only'] = $_POST['incl_only']; $grab_parameters['xs_parse_only'] = $_POST['parse_only']; $grab_parameters['xs_ind_attr'] = $_POST['ind_attr']; $grab_parameters['xs_weblog_ping'] = $_POST['weblogup']; $grab_parameters['xs_smurl'] = $_POST['smurl']; if($_POST['changepass']) { $grab_parameters['xs_login'] = trim($_POST['xslogin']); if($_POST['xspassword']!='-----') { $grab_parameters['xs_password'] = trim($_POST['xspassword']) ? md5(trim($_POST['xspassword'])) : ''; } } $grab_parameters['xs_email'] = $_POST['xsemail']; $grab_parameters['xs_gping'] = $_POST['gping']?1:0; $grab_parameters['xs_chlog'] = $_POST['gchlog']?1:0; $grab_parameters['xs_extlinks'] = $_POST['extlinks']?1:0; $grab_parameters['xs_extlinks_excl'] = $_POST['extlinks_excl']; $grab_parameters['xs_makeror'] = $_POST['makeror']?1:0; $grab_parameters['xs_maketxt'] = $_POST['maketxt']?1:0; if($sm_proc_list) foreach($sm_proc_list as $lrwvB0xvcXXumi3V) { $grab_parameters[$lrwvB0xvcXXumi3V->MY9uRPqbKXzuC] = $_POST[$lrwvB0xvcXXumi3V->MY9uRPqbKXzuC]?1:0; if($lrwvB0xvcXXumi3V->MY9uRPqbKXzuC) $grab_parameters[$lrwvB0xvcXXumi3V->GQklf5YYBHhR] = $_POST[$lrwvB0xvcXXumi3V->GQklf5YYBHhR]; } $grab_parameters['xs_webinfo'] = $_POST['webinfo']?1:0; $grab_parameters['xs_makehtml'] = $_POST['makehtml']?1:0; $grab_parameters['xs_htmlname'] = $_POST['htmlname']; $grab_parameters['xs_htmlpart'] = $_POST['htmlpart']; $grab_parameters['xs_htmlsort'] = $_POST['htmlsort']; $grab_parameters['xs_htmlstruct'] = $_POST['htmlstruct'];    $xz = 'rss'; $grab_parameters['xs_rssinfo'] = $_POST['rssinfo']?1:0; if($_POST['rssinfo']) { $grab_parameters['xs_rssfilename'] = $_POST['rssfilename']; $grab_parameters['xs_rsstitle'] = $_POST['rsstitle']; $grab_parameters['xs_rssage'] = $_POST['rssage']; $grab_parameters['xs_rssincmask'] = $_POST['rssincmask']; } $xz = '/rss'; $grab_parameters['xs_makemob'] = $_POST['makemob']?1:0; if($_POST['makemob']) { $grab_parameters['xs_mobilefilename'] = $_POST['mobilefilename']; $grab_parameters['xs_mobileincmask'] = $_POST['mobileincmask']; } $grab_parameters['xs_sm_size'] = $_POST['sm_size']; $grab_parameters['xs_sm_filesize'] = $_POST['sm_filesize']; $grab_parameters['xs_purgelogs'] = $_POST['purge']; $grab_parameters['xs_autoresume'] = $_POST['autoresume']; $grab_parameters['xs_ref_list_store'] = $_POST['ref_list_store']; $grab_parameters['xs_maxref'] = $_POST['maxref']; $grab_parameters['xs_no_cookies'] = $_POST['cookies']?0:1; $grab_parameters['xs_compress'] = intval($_POST['compress']) ; $grab_parameters['xs_usecurl'] = $_POST['usecurl']?1:0; $grab_parameters['xs_memsave'] = $_POST['memsave']?1:0; $grab_parameters['xs_inc_skip'] = '\.('.preg_replace('#\s+#','|',trim($_POST['incl'])).')'; $grab_parameters['xs_exc_skip'] = '\.('.preg_replace('#\s+#','|',trim($_POST['excl'])).')'; $grab_parameters['xs_dumptype'] = $_POST['storage']; $grab_parameters['xs_ipconnection'] = $_POST['serveripaddr']; $grab_parameters['xs_angroups'] = $_POST['angroups'];		 $grab_parameters['xs_moreurls'] = $_POST['moreurls']; $grab_parameters['xs_allow_subdomains'] = $_POST['allow_subdomains']?1:0; $grab_parameters['xs_cleanpar'] = preg_replace('#\s+#','|',trim($_POST['cleanpar'])); $grab_parameters['xs_metadesc'] = $_POST['metadesc']?1:0; $grab_parameters['xs_canonical'] = $_POST['canonical']?1:0; $grab_parameters['xs_checkver'] = $_POST['checkver']?1:0; $grab_parameters['xs_disable_xsl'] = $_POST['xslon']?0:1; $grab_parameters['xs_nobrand'] = $_POST['nobrand']?1:0; $grab_parameters['xs_robotstxt'] = $_POST['robotson']?1:0; $grab_parameters['xs_hreflang'] = $_POST['hreflang']?0:1; $grab_parameters['xs_alt_lang'] = $_POST['alt_lang']; $grab_parameters['xs_utf8'] = $_POST['xsutf'] ? 1 : 0; $grab_parameters['xs_inc_ajax'] = $_POST['xsajax'] ? 1 : 0; $grab_parameters['xs_lastmod_notparsed'] = $_POST['lmnp']?1:0; $grab_parameters['xs_debug'] = $_POST['dbg']?1:0; $grab_parameters['xs_http_language'] = $_POST['http_language']; h8i3gNivayoQQtqpLY(T9mnmC3k9eENcJDb44Q, $grab_parameters); $YGXNP4q99 = 'Configuration has been saved';		 } $CjkPFJQ1MJyQxogX = eufpjMrwNSVr(); if(count($CjkPFJQ1MJyQxogX)>0){ $YnWE4QL8VN0xpL = array_pop($CjkPFJQ1MJyQxogX); $Q5G8QmbQwJT3v = NYySB95cXj2bdre($YnWE4QL8VN0xpL); } $pcBcJ2TINs = $grab_parameters['xs_smname']; $H9ksmjIXr = ($grab_parameters['xs_compress']==1) ? '.gz' : ''; $dtVinIseWb = $grab_parameters['xs_sm_size'] ? $grab_parameters['xs_sm_size'] : 50000; for($i=0;$i<ceil($Q5G8QmbQwJT3v['ucount']/$dtVinIseWb);$i++) {    $Xm5TKOzcDly01EH2 = (($Q5G8QmbQwJT3v['ucount']>$dtVinIseWb) ? SKg9CDNyrraUeOE5uUB($i+1,$pcBcJ2TINs):$pcBcJ2TINs).$H9ksmjIXr; if(!@is_writable($Xm5TKOzcDly01EH2) && !@is_writable(dirname($Xm5TKOzcDly01EH2)) ) { if($pf = @RkxOeH9i8($Xm5TKOzcDly01EH2)) @fclose($pf); $WkR4kDkMT .= '<br>Sitemap file is not writable: <b>'.$Xm5TKOzcDly01EH2.'</b>'; } }	 if($sm_proc_list)foreach($sm_proc_list as $lrwvB0xvcXXumi3V) $WkR4kDkMT .= $lrwvB0xvcXXumi3V->mO2zEMptgTr3_9(); $dtVinIseWb = $grab_parameters['xs_htmlpart']; $pcBcJ2TINs = $grab_parameters['xs_htmlname']; for($i=0;$i<ceil($Q5G8QmbQwJT3v['ucount']/$dtVinIseWb);$i++) {    $Xm5TKOzcDly01EH2 = (($Q5G8QmbQwJT3v['ucount']>$dtVinIseWb) ? SKg9CDNyrraUeOE5uUB($i+1,$pcBcJ2TINs,true):$pcBcJ2TINs); if(!is_writable($Xm5TKOzcDly01EH2) && !is_writable(dirname($Xm5TKOzcDly01EH2)) ) $WkR4kDkMT .= '<br>Sitemap file is not writable: <b>'.$Xm5TKOzcDly01EH2.'</b>'; }	 include uNFFhEr_Ldjz6gLuOb.'page-top.inc.php'; ?>
																											<div id="sidenote">
																											<?php include uNFFhEr_Ldjz6gLuOb.'page-sitemap-detail.inc.php'; if(aRjeSjk24){ ?>
																											<div class="block1">
																											Licensed to:<br />
																											<small><?php echo str_rot13(aRjeSjk24);?></small>
																											</div>
																											<?php } ?>
																											...
																											<div id="shifted">
																											<?php $WkR4kDkMT = isset($_GET['errmsg']) ? $_GET['errmsg'] : ''; if($WkR4kDkMT){ ?>
																											<div class="block2head">
																											An error occured
																											</div>
																											<div class="block1">
																											<?php echo strip_tags($WkR4kDkMT, '<b><br>');?>
																											</div>
																											<?php }?>
																											<?php if($YGXNP4q99){ ?>
																											<div class="block1head">
																											...
																											<?php }?>
																											<h2>Configuration</h2>
																											<form name="sgform" action="index.<?php echo $szdudf1EIIL?>?submit=1" method="POST" enctype2="multipart/form-data">
																											...
																											<br/><br/>
																											<h3 style="cursor:pointer" onclick="javascript:n1xLFyVmobkiwwn('configother')" id="hconfigother">[-] Other Sitemap Types (click to collapse)</h3>
																											<div id="configother">
																											...
																											<input type="checkbox" onclick="n1xLFyVmobkiwwn('sm_html_div')" name="makehtml" <?php echo $grab_parameters['xs_makehtml']?'checked':''?> id="in12"><label for="in12"> Create html site map for your visitors</label>
																											...
																											<?php $xz = 'rss';?>
																											<input type="checkbox" name="rssinfo" <?php echo $grab_parameters['xs_rssinfo']?'checked':''?> id="rssinfo1" onclick="n1xLFyVmobkiwwn('sm_rss_div')"><label for="rssinfo1"> 
																											...
																											<input type="checkbox" name="makemob" <?php echo $grab_parameters['xs_makemob']?'checked':''?> id="mobinfo1" onclick="n1xLFyVmobkiwwn('sm_mob_div')"><label for="mobinfo1"> 
																											...
																											<?php if($sm_proc_list)foreach($sm_proc_list as $lrwvB0xvcXXumi3V) { ?>
																											<div class="inptitle">Create <?php echo $lrwvB0xvcXXumi3V->jnlmADM5fBz3W9?>:</div>
																											<input type="checkbox" onclick="n1xLFyVmobkiwwn('<?php echo $lrwvB0xvcXXumi3V->MY9uRPqbKXzuC?>_div')" name="<?php echo $lrwvB0xvcXXumi3V->MY9uRPqbKXzuC?>" <?php echo $grab_parameters[$lrwvB0xvcXXumi3V->MY9uRPqbKXzuC]?'checked':''?> id="in<?php echo $lrwvB0xvcXXumi3V->MY9uRPqbKXzuC;?>"><label for="in<?php echo $lrwvB0xvcXXumi3V->MY9uRPqbKXzuC;?>"> Create <?php echo $lrwvB0xvcXXumi3V->jnlmADM5fBz3W9;?></label>
																											<br><small><?php echo $lrwvB0xvcXXumi3V->cf9WUidVAtiud?></small>
																											<div id="<?php echo $lrwvB0xvcXXumi3V->MY9uRPqbKXzuC?>_div"<?php echo $grab_parameters[$lrwvB0xvcXXumi3V->MY9uRPqbKXzuC]?'':' style="display:none"'?>>
																											Sitemap filename:<br />
																											<input type="text" name="<?php echo $lrwvB0xvcXXumi3V->GQklf5YYBHhR?>" value="<?php echo htmlentities($grab_parameters[$lrwvB0xvcXXumi3V->GQklf5YYBHhR])?>" size="70">
																											</div>
																											<?php }?>
																											</div>
																											<h3 style="cursor:pointer" onclick="javascript:n1xLFyVmobkiwwn('configattr')" id="hconfigattr">[-] Sitemap Entry Attributes (click to collapse)</h3>
																											<div id="configattr">
																											<div class="inptitle">Change frequency:</div>
																											<select name="freq">
																											<option value="">Do not specify</option>
																											<?php $ICDtF9k5qRIaFX = array('Always','Hourly','Daily','Weekly','Monthly','Yearly','Never'); foreach($ICDtF9k5qRIaFX as $fa) echo ' <option value="'.strtolower($fa).'"'.(strtolower($fa)==$grab_parameters['xs_freq']?' selected':'').'>'.$fa.'</option>'; ?>
																											</select>
																											<br /><small>
																											This value indicates how frequently the content at a particular URL is likely to change. 
																											</small>
																											<?php $iFfOUCk1sFztqp = substr(str_replace('|',' ',$grab_parameters['xs_inc_skip']),3,-1); $UctMc3aHZAuo_n49obA = substr(str_replace('|',' ',$grab_parameters['xs_exc_skip']),3,-1); $lm = $grab_parameters['xs_lastmod']; $DOEjLOF5SKtUYVQEkD = $grab_parameters['xs_lastmodtime']; ?>
																											...
																											<input type="text" name="lastmodtime" size=30 value="<?php echo $DOEjLOF5SKtUYVQEkD?htmlentities($DOEjLOF5SKtUYVQEkD):date('Y-m-d H:i:s')?>">
																											<br /><small>
																											...
																											<h3 style="cursor:pointer" onclick="javascript:n1xLFyVmobkiwwn('miscset')" id="hmiscset">[-] Miscellaneous Settings (click to collapse)</h3>
																											<div id="miscset">
																											<div class="inptitle">Require authorization to access generator interface:</div>
																											<input type="checkbox" name="changepass" onclick="n1xLFyVmobkiwwn('loginform');" id="chgpass" />
																											...
																											<?php $ICDtF9k5qRIaFX = array('Unsorted (default)','Alphabetical (asc)','Alphabetical (desc)','Randomize'); foreach($ICDtF9k5qRIaFX as $k=>$fa) echo ' <option value="'.$k.'"'.($k==$grab_parameters['xs_htmlsort']?' selected':'').'>'.$fa.'</option>'; ?>
																											</select>
																											<select name="htmlstruct">
																											<?php $ICDtF9k5qRIaFX = array('Tree-like (default)','Folders list','Plain list'); foreach($ICDtF9k5qRIaFX as $k=>$fa) echo ' <option value="'.$k.'"'.($k==$grab_parameters['xs_htmlstruct']?' selected':'').'>'.htmlentities($fa).'</option>'; ?>
																											</select>
																											...
																											<h3 style="cursor:pointer" onclick="javascript:n1xLFyVmobkiwwn('narrow')" id="hnarrow">[-] Narrow Indexed Pages Set (click to collapse)</h3>
																											<div id="narrow">
																											<div class="inptitle">Exclude from sitemap extensions:</div>
																											<input type="text" name="excl" size="90" value="<?php echo htmlentities($UctMc3aHZAuo_n49obA)?>">
																											...
																											<input type="text" name="incl" size="90" value="<?php echo htmlentities($iFfOUCk1sFztqp)?>">
																											...
																											<select style="width:220px" onchange="WaHQCDK4QrZX(this.value)">
																											...
																											<h3 style="cursor:pointer" onclick="javascript:n1xLFyVmobkiwwn('configopt')" id="hconfigopt">[-] Crawler Limitations, Finetune (click to collapse)</h3>
																											<div id="configopt">
																											...
																											<h3 style="cursor:pointer" onclick="javascript:n1xLFyVmobkiwwn('configopt2')" id="hconfigopt2">[-] Advanced Settings (click to collapse)</h3>
																											<div id="configopt2">
																											...
																											<?php $GuFDO93OPpTOQkSZ77 = str_replace('|',' ',$grab_parameters['xs_cleanpar']); ?>
																											<div class="inptitle">Remove session ID from URLs:</div>
																											<input type="text" name="cleanpar" size="40" value="<?php echo htmlentities($GuFDO93OPpTOQkSZ77)?>">
																											<br />
																											...
																											n1xLFyVmobkiwwn('configopt');
																											n1xLFyVmobkiwwn('configopt2');
																											n1xLFyVmobkiwwn('configattr');
