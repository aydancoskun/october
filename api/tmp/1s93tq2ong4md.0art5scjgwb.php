	...
	<script src="/s/js/libs/gumby.min.js"></script>
	<script src="/s/js/plugins.js"></script>
	<script src="/s/js/main.js"></script>
	<script src="/s/libs/jQuery-Autocomplete/src/jquery.autocomplete.js"></script>
	<script src="/s/libs/jQuery-form/jquery.form.min.js"></script>
	<script src="/s/libs/jQuery-taconite/jquery.taconite.js"></script>
	<script src="/s/libs/responsive-placeholder-images/responsive-placeholder-images.js"></script>
	<script src="/s/libs/jQuery-readmore/readmore.js" type="text/javascript"></script>
	<script src="/s/libs/jQuery-dotdotdot/src/js/jquery.dotdotdot.js" type="text/javascript"></script>
	<script>
	/*
    params: 'l=jfdksl',
	...
	*/
    ...
    onSearchStart: function (query) {
    	$("#autocomplete-ajax").css({"background": "url(/s/img/searchip.gif) no-repeat right center"});
    ...
    onSearchComplete: function (query, suggestions) {
    	$("#autocomplete-ajax").css({"background": "url(/s/img/searchoff.gif) no-repeat right center"});
...
//    	$( "#str_status_msg" ).html($( "#str_status_msg_expand" ).html());
  ...
  function searchSubmit(){
  	...
  	var url = '/s/' + '<?php echo $str_page_type_search; ?>' + '/' + '<?php echo $str_page_type_submit; ?>' + '/' + queryvalue;
  ...
  function autocomplete_extra_param_update(){
	...
	//$('#autocomplete-ajax').autocomplete().setOptions({	params: { "s": searchvalue,	"t": str_page_type,	}, });
  	...
  	if(str_page_type) url = '/s/' + str_page_type;
