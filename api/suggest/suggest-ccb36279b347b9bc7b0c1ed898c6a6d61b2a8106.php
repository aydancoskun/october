...
//if (strpos($f3->get('AGENT'),"ipiresearch/Development")!==false )
define('DEBUG',false);
//else define('DEBUG',0);
...
else $f3->set('CACHE', TRUE);
$f3->set('DEBUG', DEBUG);
$f3->set('AUTOLOAD',LIB_DIR .'classes/');
$f3->set('UI',LIB_DIR .'views/');
$f3->set('ESCAPE',false);

//$f3->set('WHERE' , " WHERE industrial = 'Yes' AND no_products_found > 0 AND ");
$f3->set('WHERE' , " WHERE no_products_found > 0 AND ");
...
//require 'log/Psr/Log/LoggerInterface.php';
//require 'firelogger.php';
//$f3->set('FP', new FireLogger("api"));
//$f3->get('FP')->log("firelogger.php initialized");
if(DEBUG) {
