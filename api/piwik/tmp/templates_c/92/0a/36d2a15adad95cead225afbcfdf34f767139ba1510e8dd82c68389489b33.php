...
class __TwigTemplate_920a36d2a15adad95cead225afbcfdf34f767139ba1510e8dd82c68389489b33 extends Twig_Template
{
        ...
        ";
            ...
            if ((!array_key_exists("ecommerce", $context))) {
                ...
                if ($this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : null), "country", array(), "any", true, true)) {
                    ...
                    echo " ";
                    $this->env->loadTemplate("@Goals/_listTopDimension.twig")->display(array_merge($context, array("topDimension" => $this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : $this->getContext($context, "topDimensions")), "country", array()))));
                    echo "</li>
            ";
                }
                // line 12
                ...
                if (($this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : null), "keyword", array(), "any", true, true) && (twig_length_filter($this->env, $this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : $this->getContext($context, "topDimensions")), "keyword", array())) > 0))) {
                    ...
                    echo " ";
                    $this->env->loadTemplate("@Goals/_listTopDimension.twig")->display(array_merge($context, array("topDimension" => $this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : $this->getContext($context, "topDimensions")), "keyword", array()))));
                    echo "</li>
            ";
                }
                // line 15
                ...
                if (($this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : null), "website", array(), "any", true, true) && (twig_length_filter($this->env, $this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : $this->getContext($context, "topDimensions")), "website", array())) > 0))) {
                    ...
                    echo " ";
                    $this->env->loadTemplate("@Goals/_listTopDimension.twig")->display(array_merge($context, array("topDimension" => $this->getAttribute((isset($context["topDimensions"]) ? $context["topDimensions"] : $this->getContext($context, "topDimensions")), "website", array()))));
                    echo "</li>
            ";
                }
                // line 18
        ...
        if ((isset($context["displayFullReport"]) ? $context["displayFullReport"] : $this->getContext($context, "displayFullReport"))) {
            ...
            ";
                ...
                if (array_key_exists("idGoal", $context)) {
                    // line 59
                    echo "                ";
                    echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Goals_GoalConversionsBy", (isset($context["goalName"]) ? $context["goalName"] : $this->getContext($context, "goalName"))));
                    echo "
            ";
                } else {
                    // line 61
