...
//                    require(["//s3.amazonaws.com/downloads.mailchimp.com/js/signup-forms/popup/" + response.version + "/popup.js"], function() {
                    require(["https://www.oktick.com/themes/oktick/assets/libs/popup/popup.js"], function() {
                        require(["mojo/signup-forms/PopupSignupForm"]);
                        var f = new PopupSignupForm({ "config": response, "subscribeUrl": formSubscribeUrl });
...
//            return '//' + baseUrl + '/subscribe/form-post?u=' + uuid + '&id=' + lid;
            return '/api/capture/popup-form-post.php';
