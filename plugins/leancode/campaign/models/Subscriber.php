...
class Subscriber extends Model
{
    ...
    public $belongsToMany = [
        'subscriber_lists' => ['Leancode\Campaign\Models\SubscriberList', 'table' => 'leancode_campaign_lists_subscribers', 'otherKey' => 'list_id'],
        'messages' => ['Leancode\Campaign\Models\Message', 'table' => 'leancode_campaign_messages_subscribers', 'otherKey' => 'message_id'],
    ];
     ...
     */
    public $rules = [
        'email' => 'required|between:3,64|email|unique:leancode_campaign_subscribers',
    ];
