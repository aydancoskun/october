...
class Messages extends Controller
{
    ...
    public function index_onArchive()
    {
        if (($checkedIds = post('checked')) && is_array($checkedIds) && count($checkedIds)) {
            ...
            Flash::success('Successfully archived these messages');
        }
        else {
            Flash::error('There are no selected messages to archive.');
        }
    ...
    public function preview_onDuplicate()
    {
        ...
        Flash::success('Duplicated this campaign successfully!');
