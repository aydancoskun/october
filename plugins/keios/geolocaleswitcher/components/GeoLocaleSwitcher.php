...
class GeoLocaleSwitcher extends ComponentBase
{
    ...
    {
        return [
            'name' => 'keios.geolocaleswitcher::lang.geocomponent.title', //GeoLocaleSwitcher
            'description' => 'keios.geolocaleswitcher::lang.geocomponent.description' //Displays locale switcher with current geoIP country
        ];
    }
